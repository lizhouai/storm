...
|---|---|---|
| Direct outline | [direct_gen_outline.html](direct_gen_outline.html) | Topic-only structure before retrieval |
| Refined outline | [storm_gen_outline.html](storm_gen_outline.html) | Adds dimensions and framework distinctions found in the papers |
| Draft article | [storm_gen_article.html](storm_gen_article.html) | Writes the evidence-backed comparison with inline citations |
| Polished article | [storm_gen_article_polished.html](storm_gen_article_polished.html) | Tightens the decision guidance and adds verification notes |
